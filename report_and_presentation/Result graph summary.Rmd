...
all_result_binary %>%
  ...
  add_header_above(c("Binary Outcome" = 1, "Simple" = 2, "Empirical(no boot)" = 2, "Complex" = 2))
...
all_result_continuous %>%
  ...
  column_spec(5, width = "5cm")  %>%
  column_spec(1:7, border_left = T, border_right = T) %>%
  add_header_above(c("Continuous Outcome" = 1, "Simple" = 2, "Empirical(no boot)" = 2, "Complex" = 2))
```
