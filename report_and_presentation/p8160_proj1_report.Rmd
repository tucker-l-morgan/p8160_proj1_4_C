...
\\
&= E\left[\frac{\exp(\alpha_0 + \alpha_1 L_{1i} + \alpha_2 L_{2i} + \varepsilon_i)}{1+\exp(\alpha_0 + \alpha_1 L_{1i}+ \alpha_2 L_{2i} + \varepsilon_i)}\right]
\\
&= \frac{\exp(\alpha_0 + \alpha_1 E(L_{1i}) + \alpha_2 E(L_{2i}) + E(\varepsilon_i))}{1+\exp(\alpha_0 + \alpha_1 E(L_{1i}) + \alpha_2 E(L_{2i})  + E(\varepsilon_i))}
\\
