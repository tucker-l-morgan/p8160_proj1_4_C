...
>- Three covariates (L1, L2, L3), one confounding covariate (L2) related to both treatment (A) and outcome (Y).
...
## Results
```{r loading in binary coverage plot, echo = FALSE, message = FALSE, warning = FALSE}
library(tidyverse)
...
## Results
```{r binary standard error plot, echo = FALSE, message = FALSE, warning = FALSE}
bin_se_plot
```

## Results
```{r continuous coverage plot, echo = FALSE, message = FALSE, warning = FALSE}
source("./shared_code/cont_plots_script.R")
cont_cvg_plot
```

## Results
```{r continous standard error plot, echo = FALSE, message = FALSE, warning = FALSE}
cont_se_plot
```
