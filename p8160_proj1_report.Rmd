...
These two table show the summary of the result of all the plots above (fig 3. - fig 8.) including the standard deviation and the bias of the empirical samples, 100 sub-populations before performing the simple bootstrap (fig 1.). 
