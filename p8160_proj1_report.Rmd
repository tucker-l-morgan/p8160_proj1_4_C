...
Outcome functions were then constructed to produce the estimated treatment effect we were interested in. In these outcome functions, bootstrapped samples were passed through the GLM function, and each bootstrapped sample produced a single estimated treatment effect. [Appendix D] Then, these estimates were summarized and collected in datasets that were indexed by scenario, outcome type, and bootstrapping method. 
...
Some excerpts of the programming associated with this simulation study has been included in the Appendix. All programs are available in [this GitHub repository](https://github.com/tucker-l-morgan/p8160_proj1_4_C).
